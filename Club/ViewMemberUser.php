...
<body id="body">
    ...
    <div class=" container-fluid ">
        <div class="pt-5 pb-5 pl-5" id="search">
            <form class="form-inline my-2 my-lg-0" method="post" action="../../controller/SearchUser.php">
                <input class="form-control mr-sm-2" name="txtSearch"  type="search" placeholder="Find Member" aria-label="Search">
                <button class="btn btn-outline-success my-2 my-sm-0" type="submit">Search</button>
            </form> 
        </div>
        <table id="table"  class="table  table-responsive  w-auto" >
                ...
                <?php
                    ...
                    if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) 
                        {
                            ...
                            echo'<td><img  src="'.$imageURL.'"  alt=""  title="" width="50" height="60"></td>';
